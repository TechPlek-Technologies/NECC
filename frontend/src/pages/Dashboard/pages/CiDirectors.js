...
const CiDirectors = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${domain}/corporateInformation`, formData, {
        headers: {
          ...
          >
            <Container maxWidth="xl">
              <Stack spacing={3}>
                ...
                >
                  <Stack spacing={1}>
                    <Typography variant="h4">Corporate Information (Director)</Typography>
                  </Stack>
                  <div>
                    <Button
                      startIcon={
